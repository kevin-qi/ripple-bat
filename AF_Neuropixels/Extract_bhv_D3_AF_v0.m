...
%=== Load Data
c3d_clus_file = dir(fullfile(cd, '*_c3d_1*.mat*'));                 c3d_data = load(c3d_clus_file.name);       % Cortex
bat_filename = strsplit(c3d_clus_file.name,'_');                    bat_filename = bat_filename{1,1};
...
options.unique_ID = {'Dataset_3','14543',batdate}; % Save the session identifier
