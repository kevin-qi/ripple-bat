function [out] = loadSpikeData_AF_v1
...
useKSLabel = 0;         % Default, if using KS Label (the alternative is using manual curation)
...
save([path_to_recording_dir,'\SU_',kilosort_out_folder_name,'.mat'],'out');
