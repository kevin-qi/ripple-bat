function [weigthted_corr_p, avg_jump_p, replay_score_p, slope_p, weighted_corr_test_rp,avg_jump_distance_test_rp,slope_test_rp,replay_score_test_rp] = shuffle_validation_v2(event)
    %=== data cleaning 
    event(isnan(event)) =0;
%     event =imresize(event, [10,10]);
    [weighted_corr_unshuffled, max_jump_distance_unshuffled, avg_jump_distance_unshuffled,num_peaks_unshuffled, replay_score_unshuffled, slope_unshuffled, fitted_y_unshuffled, posterior_spread_unshuffled, com_jump_unshuffled] = evaluate_candidate_event_v3(event);
...
%         [weighted_corr_test_rp(i), max_jump_distance_test_rp(i), avg_jump_distance_test_rp(i),num_peaks_test_rp(i), replay_score_test_rp(i), slope_test_rp(i), fitted_y_test_rp{i}, posterior_spread_test_rp(i), com_jump_test_rp(i)] = evaluate_candidate_event_v3(prob_shuffled_bins);
        [weighted_corr_test_rp(i),max_jump_distance_test_rp(i), avg_jump_distance_test_rp(i), num_peaks_test_rp(i), replay_score_test_rp(i), slope_test_rp(i),fitted_y_test_rp{i}, posterior_spread_test_rp(i), com_jump_test_rp(i),~, ~,~] = evaluate_candidate_event_v7(prob_shuffled_bins);
...
%        [weighted_corr_test_cs(i), max_jump_distance_test_cs(i), avg_jump_distance_test_cs(i),num_peaks_test_cs(i), replay_score_test_cs(i), slope_test_cs(i), fitted_y_test_cs{i}, posterior_spread_test_cs(i), com_jump_test_cs(i)] = evaluate_candidate_event_v3(prob_shuffled_circshift);
       [weighted_corr_test_cs(i),max_jump_distance_test_cs(i), avg_jump_distance_test_cs(i), num_peaks_test_cs(i), replay_score_test_cs(i), slope_test_cs(i),fitted_y_test_cs{i}, posterior_spread_test_cs(i), com_jump_test_cs(i),~, ~,~] = evaluate_candidate_event_v7(prob_shuffled_circshift);
    end 
