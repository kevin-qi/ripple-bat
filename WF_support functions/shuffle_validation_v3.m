function [weigthted_corr_p, avg_jump_p, replay_score_p, slope_p] = shuffle_validation_v3(event)
    %=== data cleaning 
    event(isnan(event)) =0;
%     event =imresize(event, [10,10]);
    [weighted_corr_unshuffled, max_jump_distance_unshuffled, avg_jump_distance_unshuffled,num_peaks_unshuffled, replay_score_unshuffled, slope_unshuffled, fitted_y_unshuffled, posterior_spread_unshuffled, com_jump_unshuffled] = evaluate_candidate_event_v4(event);
